...
function analytic_eigenvalues(d::Int, n::Int, k::Int, alpha = 2.0)
...
extreme_eigvals(data::SpectralData, d::Int, ::Laplace)   = analytic_eigenvalues(d, size(data.A, 1), data.k, data.A[1,1])
